...
export const routesDatabase: Record<string, RouteData> = {
  'mersin-istanbul-evden-eve-nakliyat': {
    ...
    insuranceText: "Mersin Uzman Eller Nakliyat şehirlerarası nakliyat seferlerinin tamamını geniş kapsamlı nakliyat sigortası güvencesiyle geniş kapsamlı emtia taşıma sigortası ile koruma altına almaktadır. Mersin'den yüklenen eşyalarınız İstanbul'daki yeni adresinizde teslim edilene kadar oluşabilecek kaza, yangın, doğal afet ve yol sarsıntı hasarlarına karşı sigortalanır. geniş kapsamlı nakliyat sigortası güvencesiyle hazırlanan nakliyat poliçesi, taşınma sabahında adınıza düzenlenerek ıslak imzalı sözleşmeyle birlikte tarafınıza teslim edilir. Eşyaların taşınması sırasında oluşabilecek çizik ve sürtünme gibi küçük hasarlar ise firma içi sorumluluk garantimiz kapsamındadır.",
  ...
  'mersin-adana-evden-eve-nakliyat': {
    ...
    insuranceText: "Mersin Adana arası tüm taşımalarımız geniş kapsamlı nakliyat sigortası güvencesiyle emtia nakliyat sigortası kapsamında gerçekleştirilmektedir. Eşyalarınız yoldaki olası kaza, yangın veya devrilme risklerine karşı tamamen güvence altına alınır.",
  ...
  'mersin-gaziantep-evden-eve-nakliyat': {
    ...
    insuranceText: "Mersin Uzman Eller Nakliyat şehirlerarası nakliyat seferlerinin tamamını geniş kapsamlı nakliyat sigortası güvencesiyle geniş kapsamlı emtia taşıma sigortası ile koruma altına almaktadır. Mersin'de yüklenen eşyalarınız Gaziantep'teki yeni evinize teslim edilene kadar yol kazaları, doğal afet ve hırsızlık risklerine karşı sigortalanır. geniş kapsamlı nakliyat sigortası güvencesiyle hazırlanan poliçemiz taşınma öncesinde size sunulur. Eşyaların taşınması sırasında oluşabilecek küçük hasarlar da firmamızın garantisindedir.",
  ...
  'mersin-izmir-evden-eve-nakliyat': {
    ...
    insuranceText: "Mersin Uzman Eller Nakliyat şehirlerarası nakliyat seferlerinin tamamını geniş kapsamlı nakliyat sigortası güvencesiyle geniş kapsamlı emtia taşıma sigortası ile koruma altına almaktadır. Eşyalarınız Mersin'den yüklendiği andan itibaren İzmir'deki yeni adresinizde kurulana kadar oluşabilecek kaza, devrilme, yangın, sel gibi majör risklere karşı tam değeriyle sigortalanır. geniş kapsamlı nakliyat sigortası güvencesiyle hazırlanan poliçe nüshası taşınma sabahında adınıza düzenlenerek size takdim edilir.",
  ...
  'mersin-antalya-evden-eve-nakliyat': {
    ...
    insuranceText: "Mersin Uzman Eller Nakliyat şehirlerarası nakliyat seferlerinin tamamını geniş kapsamlı nakliyat sigortası güvencesiyle geniş kapsamlı emtia taşıma sigortası ile koruma altına almaktadır. Eşyalarınız Mersin'den yüklendiği andan itibaren Antalya'daki yeni adresinizde teslim edilene kadar geniş kapsamlı nakliyat sigortası güvencesiyle korunur. Yol boyunca yaşanabilecek tüm kaza, yangın, devrilme gibi olumsuzluklara karşı poliçeniz tam bedel üzerinden adınıza taşınma öncesinde düzenlenir.",
  ...
  'mersin-kayseri-evden-eve-nakliyat': {
    ...
    insuranceText: "Mersin Uzman Eller Nakliyat şehirlerarası nakliyat seferlerinin tamamını geniş kapsamlı nakliyat sigortası güvencesiyle geniş kapsamlı emtia taşıma sigortası ile koruma altına almaktadır. Eşyalarınız Mersin'den yüklendiği andan itibaren Kayseri'deki yeni adresinizde teslim edilene kadar oluşabilecek kaza, devrilme, yangın riskine karşı emtia nakliyat sigortası güvencesindedir. Sigorta poliçesi taşınma öncesinde adınıza düzenlenerek ıslak imzalı sözleşmeyle birlikte size teslim edilir.",
  ...
  'mersin-bursa-evden-eve-nakliyat': {
    ...
    insuranceText: "Mersin Uzman Eller Nakliyat şehirlerarası nakliyat seferlerinin tamamını geniş kapsamlı nakliyat sigortası güvencesiyle geniş kapsamlı emtia taşıma sigortası ile koruma altına almaktadır. Eşyalarınız Mersin'den yüklendiği andan itibaren Bursa'daki yeni evinize teslim edilip kurulana kadar yaşanabilecek tüm kaza, yangın, devrilme ve yol sarsıntı hasarlarına karşı geniş kapsamlı nakliyat sigortası güvencesiyle sigortalanır. Poliçe evrakı taşınma günü sabahı adınıza düzenlenerek size takdim edilir.",
...
,
  ...
  "mersin-hatay-evden-eve-nakliyat": {
    ...
    "pricingText": "Mersin Hatay nakliyat fiyatları 21.000 TL ile 25.000 TL arasında değişmekte olup, oda sayısı ve asansör gereksinimine göre kesinleştirilmektedir. emtia nakliyat sigortası poliçesi fiyata dahildir.",
    ...
    "insuranceText": "Mersin Hatay arası tüm ev taşımaları emtia nakliyat sigortası kapsamında korunmaktadır.",
  ...
  "mersin-konya-evden-eve-nakliyat": {
    ...
    "insuranceText": "Mersin Konya arası ev taşımalarımız emtia nakliyat sigortası ile yol boyunca güvence altındadır.",
  ...
  "mersin-karaman-evden-eve-nakliyat": {
    ...
    "insuranceText": "Karaman taşımalarında emtia nakliyat sigortası poliçesiyle tüm eşya grupları hasara karşı teminat altındadır.",
  ...
  "mersin-nigde-evden-eve-nakliyat": {
    ...
    "insuranceText": "Niğde taşımalarımız emtia nakliyat sigortası kapsamındadır.",
