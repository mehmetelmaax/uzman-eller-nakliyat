        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex gap-4 items-start p-4 hover:bg-gray-light/30 rounded-lg transition-colors">
            ...
            <div>
              ...
              <div className="text-orange-text font-bold text-xs uppercase tracking-wider mt-1">Mersin Yerel Tecrübesi</div>
              <p className="text-charcoal text-sm leading-relaxed mt-2">
                2006 yılından beri Yenişehir merkezli olarak Mersin'in tüm bölgelerinde güvenli taşıma yapıyoruz.
              </p>
            </div>
          </div>
