...
export default function TeklifAlPage() {
  const teklifFaqs = [
    {
      ...
      answer: 'Mersin evden eve nakliyat fiyatları 2026 yılı itibarıyla taşınacak odaların sayısına, asansör ihtiyacına ve Yenişehir merkezli taşıma mesafesine göre 15.000 TL ile 31.000 TL arasında değişmektedir.'
    },
    {
  ...
  return (
    <>
      ...
      <main className="pt-24 min-h-screen bg-brand-primary text-white flex flex-col justify-between">
          ...
          <div className="border-t border-white/10 pt-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
              <div className="bg-white/5 p-6 rounded-xl border border-white/10 space-y-2">
                <span className="font-bold text-brand-accent-dark text-sm block">✓ Sabit Fiyat Güvencesi</span>
              ...
              <div className="bg-white/5 p-6 rounded-xl border border-white/10 space-y-2">
                <span className="font-bold text-brand-accent-dark text-sm block">✓ K3 Belgeli ve Sigortalı</span>
                <p className="text-gray-300 text-xs leading-relaxed">
              ...
              <div className="bg-white/5 p-6 rounded-xl border border-white/10 space-y-2">
                <span className="font-bold text-brand-accent-dark text-sm block">✓ Ücretsiz Ön Keşif</span>
                <p className="text-gray-300 text-xs leading-relaxed">
