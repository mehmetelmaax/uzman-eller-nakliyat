        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              {route.distanceText} Uzun mesafe yolculuklarında şoförlerimizin sürüş güvenliği, araçlarımızın hız limitleri ve yol kontrolleri tamamen yasal mevzuatlara uygun şekilde planlanır. Eşyaların Mersin'deki yüklenme saatinden itibaren varış noktasındaki boşaltma planına kadar her detay müşterilerimizle koordineli şekilde yürütülür.
            </p>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">Mersin Uzman Eller Nakliyat, {route.pricingText} Aşağıdaki tabloda, iki şehir arasında farklı daire tipleri için öngörülen ortalama fiyat aralıkları listelenmiştir:</p>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">Mersin Uzman Eller Nakliyat, {route.notes} {route.tipsText} Uzun mesafe evden eve nakliye süreçlerinde adreslerin önceden netleştirilmesi ve taşınma sabahında nakliye kamyonunun yanaşacağı otopark alanının ayrılması hayati önem taşır.</p>
            <p className="text-charcoal text-sm md:text-base leading-relaxed mt-3 pt-3 border-t border-gray-light/60">
