...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/bolgeler/erdemli-evden-eve-nakliyat',
  },
};
...
export default function ErdemliPage() {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Erdemli Evden Eve Nakliyat',
        description: "Mersin Erdemli Kocahasanlı, Limonlu, Kızkalesi, Merkez mahallelerinde K3 belgeli kapalı kasa araçlarımızla sabit fiyatlı asansörlü ev taşıma.",
        slug: 'bolgeler/erdemli-evden-eve-nakliyat',
        areaName: 'Erdemli'
      }),
      breadcrumbSchema([
        { name: 'Ana Sayfa', url: '/' },
        { name: 'Bölgelerimiz', url: '/bolgeler' },
        { name: 'Erdemli', url: '/bolgeler/erdemli-evden-eve-nakliyat' }
      ]),
      faqSchema(sss)
    ]
  };
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-off-white">
        <Breadcrumb items={[{ name: 'Bölgelerimiz', url: '/#ilcelerimiz' }, { name: 'Erdemli', url: '/bolgeler/erdemli-evden-eve-nakliyat' }]} className="pt-4" />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Erdemli genelinde K3 yetki belgeli araçlarımız, kadrolu marangoz ve ambalaj ekiplerimiz ve dış cephe eşya asansörlerimizle sabit fiyat garantili profesyonel ev taşıma çözümleri sunuyoruz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Güvenilir Erdemli Nakliye Çözümleri</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Mersin'in yükselen değeri Erdemli ilçesinde evden eve nakliyat süreçlerini sıfır hata ve maksimum memnuniyetle yürütüyoruz. Uzman Eller Nakliyat olarak, yasal K3 yetki belgemiz ve sigorta güvencemizle eşyalarınızı güvende tutuyoruz. Sökülmesi gereken dolap ve mobilyalarınız uzman marangozumuz tarafından demonte edilir, kalın koruyucu patpat naylonlarla sarılır ve yeni evinizde montajı tamamlanarak çalışır vaziyette teslim edilir. Sabit fiyat garantimiz sayesinde yol ortasında ek ücret sürprizleriyle karşılaşmazsınız.
            </p>
          </div>

          <PricingMatrix />
          <BuildingAnalysis districtName="Erdemli" />
          <RelatedLinks currentSlug="erdemli-evden-eve-nakliyat" type="bolge" />

          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              <MapPin className="w-6 h-6 text-orange" />
              <span>Erdemli'ta Hizmet Verdiğimiz Başlıca Mahalleler</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Erdemli ilçesinin her mahallesine asansörlü nakliye araçlarımızla kesintisiz ulaşıyoruz. Yoğun olarak hizmet verdiğimiz mahallelerden bazıları şunlardır:
            </p>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Erdemli Bina Yapısı ve Eşya Asansörü İhtiyacı</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Erdemli ilçesinde binaların kat yükseklikleri ve site kuralları nedeniyle dış cephe mobil eşya asansörlerinin kullanımı taşıma güvenliğini üst seviyeye taşır. Dar merdiven boşluklarında eşyaların çizilmesini engellemek ve bina sakinlerini rahatsız etmemek adına 25. kata kadar uzanabilen asansörlerimizle balkon veya pencerelerden doğrudan yükleme yapıyoruz. Ekiplerimiz taşınma öncesinde asansör kurulum alanı fiziki şartlarını inceleyerek en güvenli planı hazırlar.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Erdemli Evden Eve Nakliyat Fiyatları</span>
            </h2>
