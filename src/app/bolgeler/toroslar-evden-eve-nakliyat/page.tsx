...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/bolgeler/toroslar-evden-eve-nakliyat',
  },
};

export default function ToroslarPage() {
  const sss = [
  {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Toroslar Evden Eve Nakliyat',
        description: "Mersin Toroslar Halkkent, Çağdaşkent, Yusuf Kılıç, Yalınayak mahallelerinde K3 belgeli kapalı kasa araçlarımızla sabit fiyatlı asansörlü ev taşıma.",
        slug: 'bolgeler/toroslar-evden-eve-nakliyat',
        areaName: 'Toroslar'
      }),
      breadcrumbSchema([
        { name: 'Ana Sayfa', url: '/' },
        { name: 'Bölgelerimiz', url: '/bolgeler' },
        { name: 'Toroslar', url: '/bolgeler/toroslar-evden-eve-nakliyat' }
      ]),
      faqSchema(sss)
    ]
  };
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-off-white">
        <Breadcrumb items={[{ name: 'Bölgelerimiz', url: '/#ilcelerimiz' }, { name: 'Toroslar', url: '/bolgeler/toroslar-evden-eve-nakliyat' }]} className="pt-4" />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight">
            Toroslar Evden Eve Nakliyat
          </h1>
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Toroslar genelinde K3 yetki belgeli araçlarımız, kadrolu marangoz ve ambalaj ekiplerimiz ve dış cephe eşya asansörlerimizle sabit fiyat garantili profesyonel ev taşıma çözümleri sunuyoruz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Toroslar Bina Yapısı ve Eşya Asansörü İhtiyacı</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Toroslar ilçesinde binaların kat yükseklikleri ve site kuralları nedeniyle dış cephe mobil eşya asansörlerinin kullanımı taşıma güvenliğini üst seviyeye taşır. Dar merdiven boşluklarında eşyaların çizilmesini engellemek ve bina sakinlerini rahatsız etmemek adına 25. kata kadar uzanabilen asansörlerimizle balkon veya pencerelerden doğrudan yükleme yapıyoruz. Ekiplerimiz taşınma öncesinde asansör kurulum alanı fiziki şartlarını inceleyerek en güvenli planı hazırlar.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Toroslar Evden Eve Nakliyat Fiyatları</span>
            </h2>
